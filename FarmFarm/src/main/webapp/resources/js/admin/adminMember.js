...
const printMemberList = (memberList, pagination) => {
    ...
    const paginationArea = document.createElement('ul');
    paginationArea.classList.add('admin-pagination');

    middleBoard.append(paginationArea);
