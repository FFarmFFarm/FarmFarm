                                            ...
                                            <%-- 변수 선언 --%>
                                                ...
                                                <section class="signup">
                                                    ...
                                                    <div class="farm-img">
                                                        ...
                                                        <div class="farm-img-upload1">
                                                            <div class="farm-img-ex">
                                                                <img src="/resources/images/member/farmerex.jpg">
                                                            </div>
                                                            <p>인증 사진 예시</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <section class="agree-wrap agree-wrapper agree">
                                                    <i class="fa-solid fa-check check-icon">
                                                        <input type="checkbox" name="agree" id="agreeInput1">
                                                    </i>
                                                    <div class="agree-text agree-text1">농장인증 절차 확인(필수)</div>
                                                </section>
                            ...
                            <div class="container" id="modal-text">
                                <div class="container-sub">
                                    <div class="modal-middle">
                                        <h2 class="h2">[농장 사진 인증 안내]</h2>
                                        판매자로 가입 시 본인이 나온 농장 사진을 관리자에게 인증 받아야 가입 가능합니다. 가입 절차는 1-2일 소요됩니다. <br><br><br>
