        ...
        <%-- 문자열 관련 메서드를 제공하는 JSTL (EL형식) --%>
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <head>
                    ...
                    <link rel="stylesheet" href="/resources/css/member/signUpAgree-style.css">
                ...
                <body>
                            ...
                            <div class="container">
                                <div class="container-sub">
                                    ...
                                    <div class="close-wrap">
                                        <button type="button" onclick="window.close();" id="close-btn-wrap">
                                            <div class="close-btn">
                                                확인
                                            </div>
                                        </button>
                    ...
                    <script>
                        // const closeBtnWrap = document.querySelector(".close-btn-wrap");
                        // const agree = document.querySelector(".agree");

                        // closeBtnWrap.addEventListener("click", () => {
