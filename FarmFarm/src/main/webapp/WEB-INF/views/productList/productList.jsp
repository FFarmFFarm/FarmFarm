        ...
        <div class="swiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img src="/resources/images/productList/listbg1.png">
                </div>
                <div class="swiper-slide">
                    <img src="/resources/images/productList/listbg2.png">
                </div>
                <div class="swiper-slide">
                    <img src="/resources/images/productList/listbg3.png">
                </div>
            </div>
            <div>
            ...
            <article class="list-area-body">
                ...
                <c:if test="${! empty productMap}">
                    ...
                    <c:forEach items="${productMap.productList}" var="map" >
                        ...
                        <a href="/products/${map.productNo}" class="product-box">
