...
<c:set var="reportAllList" value="${map.reportAllList}" />
<c:set var="reportAllCount" value="${map.reportAllCount}" />
...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/admin/adminReportList-style.css" />
...
<body>
            ...
            <div class="report-total-div">
                ...
                <div class="report-select">
                    <table class="report-list-table">
                        <tr class="report-list-header">
                            ...
                            <th class="report-list-type" id="thTypeFilter">
                              <span id="dropBtn">
                                ...
                                <i class="fa-solid fa-caret-down filter-icon" id="dropBtn"></i>
                              </span>
                        ...
                        <tbody id="tbody">
                         <!--todo: 한 행 반복 / ajax생성 -->
                          <c:forEach var="report" items="${reportAllList}">
                            ...
                            <tr class="report-list-row">
                              ...
                              <c:if test="${not empty report.reportType}">
                                ...
                                <c:if test="${report.reportType eq 'B' || report.reportType eq 'P' || report.reportType eq 'C'}">
    ...
    <script src="/resources/js/admin/adminReportList.js"></script> 
