...
public class ReviewPagination {
   ...
   private int limit = 2;         // 한 페이지 목록에 보여지는 게시글 수
   private int pageSize = 1;      // 보여질 페이지 번호 개수
   ...
   public ReviewPagination(int listCount, int currentPage) {
   ...
   public ReviewPagination(int listCount, int currentPage, int limit, int pageSize) {
      this.listCount = listCount;
      this.currentPage = currentPage;
      this.limit = limit;
