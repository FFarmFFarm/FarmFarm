package edu.kh.farmfarm.seller.model.vo;

public class SellerPagination {
   ...
   public SellerPagination(int listCount, int currentPage) {
   ...
   public SellerPagination(int listCount, int currentPage, int limit, int pageSize) {
      this.listCount = listCount;
      this.currentPage = currentPage;
      this.limit = limit;
